  ...
  return {
    store: {
      ...
      fiscalFilms: [
        ...
        {
          title: "Ukrainian Cello Documentary",
          type: "Documentary",
          status: "Pre-Production",
          ...
          logline:
            "Defiantly pitting art against totalitarianism,  cellist Matt Haimovitz travels from Marfa, Texas to war-weary Ukraine, to perform Ukrainian composer Thomas de Hartmann’s forgotten anti-fascisct Cello Concerto (1935) with the Odesa Symphony. Presented with Ukrainian voices, past and present, Matt reveals the power of music to inspire hope amidst chaos.",
          synopsis:
            "This hour-long documentary is an exploration of the transformative power of music amidst the current conflict in Ukraine, offering a lens through which to understand the echoes of cultural, historical, political, and social context of the conflict. Born in Ukraine to Russian diplomats, avante-garde composer Thomas de Hartmann, served as a Russian soldier in WWI, but, because of the many political conflicts throughout his life, lived mainly as an expat. His 1935 Cello Concerto, was composed after the Ukrainian independence movement, famine, and in the lead up to WWII; it was written to make a defiant anti-fascist statement in contrast to growing anti-semitism in Eastern Europe.  deHartmann’s Cello Concerto has never been performed in Ukraine. Now, alongside the Odesa Philharmonic Orchestra, featured cello soloist Matt Haimowitz will bring this work to the people of Ukraine, touring Odesa, Lviv, Kyiv, and Vinnytsa, in May 2024. This forgotten music is a symbol of the resolve and spirit of Ukraine, and Matt Haimovitz and the Odesa Symphony intend to complete the circuit on deHartmann’s inspiration by highlighting this message today. Through the prism of Ukrainian composer Thomas de Hartmann's overlooked masterpiece and the personal journey of cellist Matt Haimovitz, viewers will witness how art and collaboration bridge political and cultural divides, emerging as a potent tool of resistance against injustice, while simultaneously providing solace, fostering unity, and igniting hope in the midst of armed conflict. Against the backdrop of Ukraine's complex history of conflict with Russia, the film dips into the resonant narratives of resilience and perseverance embodied by the musicians in the Odesa Philharmonic Orchestra. As the orchestra embarks on their first tour back home, the documentary illuminates the individual stories of its musicians and audiences attending the concerts, weaving a rich tapestry of human experience that reflects the indomitable spirit of the Ukrainian people. Amidst the challenges of war and political upheaval, music emerges as a universal language, capable of bridging divides and offering a beacon of light in dark times. However, filming in Ukraine presents its own set of challenges and considerations. The ongoing conflict in the eastern regions of Donetsk and Luhansk, as well as political tensions in the capital, Kyiv, may pose logistical and safety concerns for the filmmaking process. Navigating language barriers and bureaucratic hurdles to gain access to key locations and interviewees will require careful planning and collaboration with native Ukrainian filmmakers — a collaboration that mirrors the journey that Matt Haimovitz is sharing with his contemporaries in the Odesa Symphony. Despite these challenges, the documentary shines a spotlight on the collective narrative of the Orchestra of Odessa, as a testament to the power of art to unite humanity in the pursuit of hope and healing.",
        },
      ],
      content: [
        {
