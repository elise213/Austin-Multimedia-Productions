    ...
    store: {
      ...
      fiscalFilms: [
        ...
        },
        {
          ...
          logline:
            "At the Texas-Mexico border, Felicia Rangel-Samponaro stands as a formidable guardian, defying seemingly insurmountable odds to sustain The Sidewalk School, offering free education, safety and security to vulnerable child asylum seekers in Matamoros.",
          synopsis:
            "In Matamoros, Mexico, we enter The Sidewalk School at a child's eye level. Little by little cumulative scenes reveal its students are seeking asylum on the U.S. Mexico border facing huge stress. Yet, even after long, unimaginable treks fleeing violence, persecution, and climate change, in this makeshift space childhood can still safely function. Children form friendships, enjoy play, form a beloved community, process strong emotions like fear and rage, experience trusting multigenerational connections, and learn. We’ll follow two students and witness through their vibrant moments of connection their flourishing, with understanding adult teachers, many who are former asylum seekers themselves. The children play, form friendships, and learn to recognize and name feelings. The story shifts to show the school’s founder, a Black Latina former teacher from Houston, Felicia Rangel-Samponaro, wrestling with daily pressures. Perspective broadens. All around the children is danger. Violence, racism, hostility, the cartel. Felicia gets the sick to treatment, deals with emergencies, speaks out against racist denial of care. As a first responder and care worker providing a vital community hub she bears witness to realities and decries disinformation. The enriching environment she and her team provide is like a precious oasis, subsisting precariously amid life-threatening circumstances and hateful policies as they strive to provide a DIY solution in a vacuum of care.  This nuanced portrayal of child asylum seekers as they truly are challenges fear mongering narratives that sow division.",
        },
      ],
      content: [
        {
